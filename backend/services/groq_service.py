...
# Cliente Groq — lê a GROQ_API_KEY do ambiente
...
- Após **2 tentativas de resolução sem sucesso**, ou se o problema for claramente físico (queda, derramamento, hardware danificado, sem hardware disponível), encaminhe a um técnico humano.
